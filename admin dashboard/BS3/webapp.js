  ...
  $(document).on('click', '.function_edit a', function(e){
    ...
    request.done(function(output){
      if (output.result == 'success'){
        ...
        $('#form_company .field_container label.error').hide();
        $('#form_company .field_container').removeClass('valid').removeClass('error');
        $('#form_company #company').val(output.data[0].company);
        $('#form_company #firstname').val(output.data[0].firstname);
        $('#form_company #lastname').val(output.data[0].lastname);
        $('#form_company #username').val(output.data[0].username);
        $('#form_company #email').val(output.data[0].email);
        $('#form_company #functie').val(output.data[0].functie);
        hide_loading_message();
        show_lightbox();
      } else {
        hide_loading_message();
